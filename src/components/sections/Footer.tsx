        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Premium beauty services crafted with passion and expertise. Your
              beauty, our artistry.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-muted-foreground">
              <span className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-primary" /> Sant Tukaram nagar,
                Bhosari , Pune
              </span>
              <span className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-primary" /> 7020238843
              </span>
              <span className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-primary" /> madhuri@mssalon.com
              </span>
            </div>
          </div>
        </div>
